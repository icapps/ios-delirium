...
extension UIFont {
    ...
    private class func preferredFont(for descriptor: UIFontDescriptor, with family: String) -> UIFont {
        let customFontDescriptor = UIFontDescriptor.init(fontAttributes: convertToUIFontDescriptorAttributeNameDictionary([
            convertFromUIFontDescriptorAttributeName(UIFontDescriptor.AttributeName.family): family,
            convertFromUIFontDescriptorAttributeName(UIFontDescriptor.AttributeName.size): descriptor.pointSize
            ]))
